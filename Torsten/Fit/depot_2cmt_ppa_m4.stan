...
// Deals with BLOQ values by the "CDF trick" (M4 in NONMEM)
...
parameters{ 
  ...
  real<lower = 0.5*(TVCL/TVVC + TVQ/TVVC + TVQ/TVVP + 
                    sqrt((TVCL/TVVC + TVQ/TVVC + TVQ/TVVP)^2 - 
                    4*TVCL/TVVC*TVQ/TVVP))> TVKA;  
...
model{ 
  ...
  TVKA ~ normal(0, scale_tvka) T[0.5*(TVCL/TVVC + TVQ/TVVC + TVQ/TVVP + 
                                      sqrt((TVCL/TVVC + TVQ/TVVC + TVQ/TVVP)^2 -
